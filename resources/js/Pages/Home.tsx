...
const Home: React.FC = observer(() => {
    ...
    const statistics = [
        {
            label: "Проклятых душ",
            value: statisticsStore.statistics?.users_count || "...",
            icon: "👤",
        },
        {
            label: "Созданных персонажей",
            value: statisticsStore.statistics?.characters_count || "...",
            icon: "🧙",
        },
        {
    ...
    return (
        <MainLayout>
                ...
                <div className="container mx-auto h-full px-4 flex flex-col justify-center relative z-10">
                    <div className="max-w-2xl">
                        ...
                        <p className="text-lg text-gray-100 mb-8 leading-relaxed drop-shadow-md font-medieval animate-fade-in">
                            ...
                            РУИНЫ, НАСЕЛЕННЫЕ ПРОКЛЯТЫМИ ДУШАМИ, ЖДУТ ХРАБРЕЦОВ,
                            ГОТОВЫХ БРОСИТЬ ВЫЗОВ СУДЬБЕ.
                        </p>
                            ...
                            {authStore.isAuthenticated ? (
                                ...
                                <>
                                    ...
                                    <Button
                                        ...
                                        to="/auth"
                                    >
                                        <span className="mr-2">🔑</span> Войти
                                    </Button>
                                </>
                            )}
                        </div>
                    ...
                    <div className="container mx-auto px-4 relative z-10">
                        <div className="flex justify-between items-center mb-8">
                            <div className="flex items-center">
                                ...
                                <h2 className="text-red-500">Ваши персонажи</h2>
                            </div>
                            <div className="flex items-center gap-4">
                                ...
                                <Button
                                    ...
                                    size="sm"
                                    to="/character/create"
                                    disabled={!characterStore.canCreateMore}
                                >
            ...
            {/* Статистика игры - более стильная */}
            ...
            <section className="py-16 bg-gradient-to-b from-gray-900 to-gray-800">
                <div className="container mx-auto px-4">
                    <div className="flex justify-between items-center mb-8">
                        <div className="flex items-center">
                            <div className="w-1 h-8 bg-red-700 mr-3"></div>
                            <h2 className="text-red-500">Вести из тьмы</h2>
                        </div>
                        <Button variant="secondary" size="sm" to="/news">
                            <span className="mr-1">📜</span> Все новости
                        </Button>
                    </div>
                ...
                <section className="py-20 relative">
                    ...
                    <div className="container mx-auto px-4 text-center relative z-10">
                        ...
                        <p className="text-gray-200 max-w-2xl mx-auto mb-10 text-lg drop-shadow-md">
                            Тени шепчут твое имя. Присоединяйся к проклятым и
                            раскрой тайны забытого мира.
                        </p>
